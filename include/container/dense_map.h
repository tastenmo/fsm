...
public:
    ...
    using iterator = details::dense_map_iterator<typename packed_container_type::iterator>;
    /*! @brief Constant input iterator type. */
    using const_iterator = details::dense_map_iterator<typename packed_container_type::const_iterator>;
    /*! @brief Input iterator type. */
    using local_iterator = details::dense_map_local_iterator<typename packed_container_type::iterator>;
    /*! @brief Constant input iterator type. */
    using const_local_iterator = details::dense_map_local_iterator<typename packed_container_type::const_iterator>;
     ...
     */
    template<typename Other>
    [[nodiscard]] std::enable_if_t<mpl::is_transparent_v<hasher> && mpl::is_transparent_v<key_equal>, std::conditional_t<false, Other, size_type>>
     ...
     */
    template<typename Other>
    [[nodiscard]] std::enable_if_t<mpl::is_transparent_v<hasher> && mpl::is_transparent_v<key_equal>, std::conditional_t<false, Other, iterator>>
    ...
    /*! @copydoc find */
    template<typename Other>
    [[nodiscard]] std::enable_if_t<mpl::is_transparent_v<hasher> && mpl::is_transparent_v<key_equal>, std::conditional_t<false, Other, const_iterator>>
     ...
     */
    template<typename Other>
    [[nodiscard]] std::enable_if_t<mpl::is_transparent_v<hasher> && mpl::is_transparent_v<key_equal>, std::conditional_t<false, Other, std::pair<iterator, iterator>>>
    ...
    [[nodiscard]] std::enable_if_t<mpl::is_transparent_v<hasher> && mpl::is_transparent_v<key_equal>, std::conditional_t<false, Other, std::pair<const_iterator, const_iterator>>>
     ...
     */
    template<typename Other>
    [[nodiscard]] std::enable_if_t<mpl::is_transparent_v<hasher> && mpl::is_transparent_v<key_equal>, std::conditional_t<false, Other, bool>>
