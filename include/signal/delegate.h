...
namespace signal
{
    ...
    namespace details
    {
        ...
        using function_pointer_t = decltype(details::function_pointer(std::declval<Type>()...));
    ...
    public:
        ...
        void connect() noexcept
        {
            ...
            {
                fn = wrap<Candidate>(details::index_sequence_for(details::function_pointer_t<decltype(Candidate)>{}));
            }
        }
        ...
        void connect(Type &value_or_instance) noexcept
        {
            ...
            {
                fn = wrap<Candidate>(value_or_instance, details::index_sequence_for(details::function_pointer_t<decltype(Candidate), Type>{}));
            }
        }
     ...
     */
    template <auto Candidate>
    delegate(connect_arg_t<Candidate>) -> delegate<std::remove_pointer_t<details::function_pointer_t<decltype(Candidate)>>>;
     ...
     */
    template <auto Candidate, typename Type>
    delegate(connect_arg_t<Candidate>, Type &&) -> delegate<std::remove_pointer_t<details::function_pointer_t<decltype(Candidate), Type>>>;
