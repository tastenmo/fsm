...
struct type_index final {
  [[nodiscard]] static id_type next() noexcept {
    static id_type value{}; // std::atomic<Type>
    return value++;
  }
};
...
template <typename Type> [[nodiscard]] static id_type type_hash(char) noexcept {
...
template <typename Type, typename = void> struct type_index final {
  ...
  [[nodiscard]] static id_type value() noexcept {
    static const id_type value = details::type_index::next();
    return value;
  }
...
template <typename Type, typename = void> struct type_hash final {
  ...
  [[nodiscard]] static constexpr id_type value() noexcept {
    return details::type_hash<Type>(0);
#else
  [[nodiscard]] static constexpr id_type value() noexcept {
...
template <typename Type, typename = void> struct type_name final {
  ...
  [[nodiscard]] static constexpr std::string_view value() noexcept {
    return details::type_name<Type>(0);
  }
