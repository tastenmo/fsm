...
struct receiver {
  static void forward(spie::dispatcher &dispatcher, an_event &event) {
...
TEST_CASE("Dispatcher_Functionalities", "[Dispatcher]") {
  spie::dispatcher dispatcher;
  spie::dispatcher other;
  receiver receiver;
...
TEST_CASE("Dispatcher_CustomAllocator", "[Dispatcher]") {
  ...
  spie::dispatcher dispatcher{allocator};
