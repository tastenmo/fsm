 ...
 * @brief Delegates based on ENTT by Michele Caini
 * @version 0.1
 * @date 2022-10-07
 *
...
constexpr auto function_pointer(Ret (*)(Type, Args...),
                                Other &&) -> Ret (*)(Args...);

template <typename Class, typename Ret, typename... Args, typename... Other>
constexpr auto function_pointer(Ret (Class::*)(Args...),
                                Other &&...) -> Ret (*)(Args...);

template <typename Class, typename Ret, typename... Args, typename... Other>
constexpr auto function_pointer(Ret (Class::*)(Args...) const,
                                Other &&...) -> Ret (*)(Args...);
...
using function_pointer_t =
    decltype(details::function_pointer(std::declval<Type>()...));
  ...
  [[nodiscard]] auto wrap(std::index_sequence<Index...>) noexcept {
    return [](const void *, Args... args) -> Ret {
      ...
      return static_cast<Ret>(std::invoke(
          Candidate,
          std::forward<
              mpl::type_list_element_t<Index, mpl::type_list<Args...>>>(
  ...
  [[nodiscard]] auto wrap(Type &, std::index_sequence<Index...>) noexcept {
    return [](const void *payload, Args... args) -> Ret {
      ...
      Type *curr = static_cast<Type *>(
          const_cast<mpl::constness_as_t<void, Type> *>(payload));
      return static_cast<Ret>(std::invoke(
          Candidate, *curr,
          std::forward<
              mpl::type_list_element_t<Index, mpl::type_list<Args...>>>(
...
public:
  ...
  template <auto Candidate> void connect() noexcept {
    ...
    if constexpr (std::is_invocable_r_v<Ret, decltype(Candidate), Args...>) {
      ...
      fn =
          wrap<Candidate>(details::index_sequence_for<
                          mpl::type_list_element_t<0, mpl::type_list<Args...>>>(
              details::function_pointer_t<decltype(Candidate)>{}));
    } else {
      fn = wrap<Candidate>(details::index_sequence_for(
          details::function_pointer_t<decltype(Candidate)>{}));
    }
  }
  ...
  void connect(Type &value_or_instance) noexcept {
    ...
    if constexpr (std::is_invocable_r_v<Ret, decltype(Candidate), Type &,
      ...
      fn = wrap<Candidate>(
          value_or_instance,
          details::index_sequence_for(
              details::function_pointer_t<decltype(Candidate), Type>{}));
    }
  }
  ...
  Ret operator()(Args... args) const {
    FSM_ASSERT(static_cast<bool>(*this), "Uninitialized delegate");
